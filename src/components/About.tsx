            ...
            <div className="container mx-auto px-4">
                ...
                <div className="bg-dark-surface text-white rounded-none p-8 md:p-16 relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12 relative z-10">
                            ...
                            <ul className="space-y-6">
                                <li className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400 text-sm mt-1">Our advanced machinery ensures cuts are accurate to the millimeter, eliminating gaps seen in manual carpentry.</p>
                                    </div>
                                </li>
                                <li className="flex items-start">
                                    <div className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center mr-4 flex-shrink-0 text-secondary">
                        ...
                        <div className="md:w-1/2 w-full relative group perspective-1000">
                            {/* Decorative Background Box */}
                            <div className="absolute inset-0 bg-secondary/20 rounded-sm transform translate-x-4 pl-4 translate-y-4 group-hover:translate-x-2 group-hover:translate-y-2 transition-all duration-500 z-0"></div>
                            ...
                            <div className="relative z-10 overflow-hidden rounded-sm shadow-2xl border-2 border-white/10 group-hover:border-secondary/50 transition-colors duration-500">
                                ...
                                />
                                {/* Overlay gradient */}
                                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-60 group-hover:opacity-20 transition-opacity duration-500"></div>

                                {/* Label built into image */}
                                <div className="absolute bottom-6 left-6 right-6 transform translate-y-8 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-500">
                                    <div className="bg-black/80 backdrop-blur-md p-4 border-l-4 border-secondary rounded-r-sm">
                                        <p className="text-white font-bold text-lg tracking-wide">Factory Machinery</p>
                                        <p className="text-gray-400 text-sm">Mm-level metal manufacturing</p>
                                    </div>
                                </div>
                            </div>
                        </div>
